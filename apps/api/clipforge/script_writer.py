...
SCRIPT_WRITER_V2_INSTRUCTIONS = (
    ...
    "teaser, or clickbait. Begin with the actual explanation. Use only the supplied facts for "
    "substantive factual claims and attach the corresponding fact IDs to each factual block. "
    "Write natural spoken narration with logical order, short understandable sentences, concise "
    "transitions, no filler, no reassurance, no repeated question, no repeated facts, no source "
    "language, no editorial attribution, no URLs, no citations, no Markdown, no HTML, and no "
    "artificial drama. Do not pad toward the optional duration guidance. Stop when the explanation "
    "is complete. Use only these roles: answer, explanation, support, and payoff. A payoff may "
    "have no fact ID only when it adds no new factual claim. Never expose fact IDs in spoken text. "
