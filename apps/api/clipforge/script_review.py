...
SCRIPT_REVIEW_V2_INSTRUCTIONS = (
    ...
    "language, follows a logical order, avoids filler, reassurance, repetition, list-like writing, "
    "awkward transitions, article-like wording, unsupported additions, malformed speech, and "
    "tangents. Prefer concise and complete over shortest possible. Preserve useful causal context. "
    "If the draft is sound, approve it. If it needs improvement, return a complete revised draft "
    "using only answer, explanation, support, and payoff roles. Preserve valid fact IDs for every "
    "factual block. Do not add hooks, sources, URLs, HTML, Markdown, or source attribution. Return "
